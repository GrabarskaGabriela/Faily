        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-sm border-dark">
                <div class="card-body" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%);" >
                    <h3 class="card-title text-center mb-4 text-white">{{ __('auth.authregister.titleLabel') }}</h3>
                    ...
                    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="name" class="form-label text-white">{{ __('auth.authregister.usernameLabel') }}</label>
                        ...
                        <div class="mb-3">
                            <label for="email" class="form-label text-white">{{ __('auth.authregister.emailLabel') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="password" class="form-label text-white">{{ __('auth.authregister.passwordLabel') }}</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="password_confirmation" class="form-label text-white">{{ __('auth.authregister.confirmPasswordLabel') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="first_name" class="form-label text-white">{{ __('auth.authregister.firstNameLabel') }}</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="last_name" class="form-label text-white">{{ __('auth.authregister.lastNameLabel') }}</label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label for="age" class="form-label text-white">{{ __('auth.authregister.ageLabel') }}</label>
                                <input type="number" class="form-control" id="age" name="age" value="{{ old('age') }}" placeholder="{{ __('auth.authregister.agePlaceholder') }}">
                            </div>
                            <div class="col-md-8 mb-3">
                                <label for="phone" class="form-label text-white">{{ __('auth.authregister.phoneLabel') }}</label>
                                <input type="tel" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" placeholder="{{ __('auth.authregister.phonePlaceholder') }}">
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="description" class="form-label text-white">{{ __('auth.authregister.bioLabel') }}</label>
                        ...
                        <div class="mb-3">
                            ...
                            <label for="eventPhoto" class="btn text-white border-dark mt-2" style="background: linear-gradient(135deg, #5a00a0 0%, #7f00d4 100%);">
                                {{ __('auth.authregister.profilePhotoLabel') }}
                            </label>
                            <div id="fileName" class="mt-2 small text-white">{{ __('auth.authregister.fileNotChoosen') }}</div>
                        </div>


                        <div class="d-grid gap-2">
                            <button type="submit" class="btn text-white border-dark" style="background: linear-gradient(135deg, #5a00a0 0%, #7f00d4 100%);">{{ __('auth.authregister.registerButton') }}</button>
                        </div>
                    </form>
                    ...
                    <div class="text-center">
                        <p class="mb-3 text-white">{{ __('auth.authregister.alreadyHaveAccountText') }}</p>
                        <a href="{{ route('login') }}" class="btn text-white border-dark" style="background: linear-gradient(135deg, #5a00a0 0%, #7f00d4 100%);">{{ __('auth.authregister.loginLink') }}</a>
                    </div>
                </div>
            </div>
        </div>
