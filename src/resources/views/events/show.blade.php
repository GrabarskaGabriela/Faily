...
<main class="container mt-5 mb-5 text-white">
    ...
    @if(session('success'))
        <div class="alert alert-success alert-dismissible fade show mb-4" role="alert"
             style="background: linear-gradient(135deg, #00a01d 0%, #00d429 100%); border: none; color: white;">
    ...
    @if(session('error'))
        <div class="alert alert-danger alert-dismissible fade show mb-4" role="alert"
             style="background: linear-gradient(135deg, #d40000 0%, #ff0000 100%); border: none; color: white;">
    ...
    @if(session('info'))
        <div class="alert alert-info alert-dismissible fade show mb-4" role="alert"
             style="background: linear-gradient(135deg, #007ad4 0%, #00a0ff 100%); border: none; color: white;">
