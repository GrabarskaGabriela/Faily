...
<head>
    ...
    <title>Faily - Moje wydarzenia</title>
...
<body class="bg-main">
    ...
    <main class="container mt-5 mb-5">
        <h1 class="fw-bold mb-4 text-white">Moje wydarzenia</h1>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-black h-100 shadow text-white" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%);">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <a href="{{ route('events.show', $event->id) }}"  class="btn text-white border-dark" style="background: linear-gradient(135deg, #5a00a0 0%, #7f00d4 100%);">Zobacz</a>
